...
if __name__ == "__main__":
    aria_video_path = Path('/home/reggev/shared/aria/aria_2025-09-10-16-59-44.mp4')
    sensor_video_path = Path('/home/reggev/shared/sensor/sensor_2025-09-10-16-59-14.mp4')
