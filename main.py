...
if __name__ == "__main__":
    ...
    parser.add_argument("--aria-ip", type=str, default="132.69.202.2", help="Aria device IP address")
    ...
    device, device_client = utils.prepare_aria_video(device_ip=aria_ip)
